          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Na kladenjehr.com, poštujemo vašu privatnost i predani smo zaštiti vaših osobnih podataka. Ova politika
                privatnosti informirat će vas o tome kako se brinemo o vašim osobnim podacima kada posjetite našu web
                stranicu i reći će vam o vašim pravima privatnosti i kako vas zakon štiti.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-3 text-gray-700 ml-4">
                ...
                <li>
                  Tehnički Podaci uključuju IP adresu, podatke o prijavi, vrstu i verziju pretraživača, operativni
                  sustav i platformu.
                </li>
                <li>
            ...
            <section className="bg-gray-50 p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Moguće je postaviti svoj pretraživač da odbije sve ili neke kolačiće, ili da vas upozori kada web
                stranice postavljaju ili pristupaju kolačićima. Ako isključite ili odbijete kolačiće, imajte na umu da
                neke dijelove ove web stranice mogu postati nedostupne ili neće funkcionirati adekvatno. Za više
                informacija o kolačićima koje koristimo, pogledajte našu Politiku Kolačića.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                ograničavamo pristup vašim osobnim podacima samo onima zaposlenima, agentima, ugovornicima i drugim
                trećim stranicama koje imaju poslovnu potrebu za znati.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Spremimo ćemo vaši osobni podaci samo toliko dugo koliko je razumno potrebno za ispunjavanje svrha za
                koje su ih prikupili, uključujući svrhe ispunjavanja svih zakonskih, pravnih, fiskalnih, računskih ili
            ...
            <section className="bg-gray-50 p-8 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Ova web stranica može uključivati veze na web stranice trećih stranica, dodatak i aplikacije. Klikom na
                te veze ili aktiviranjem tih veza može se omogućiti da treći stranici prikupljaju ili dijele podatke o
                vama. Ne kontroliramo ove web stranice treće stranice i ne odgovaramo za njihove politike privatnosti.
              </p>
            </section>
